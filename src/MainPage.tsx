      ...
      <StyledHTMLTable striped>
        ...
        {items.map(item => (
          <tr key={item.id}>
            ...
            <StyledTd>{item.grid}</StyledTd>
            <StyledTd>{item.manufacturingMethod}</StyledTd>
            <StyledTd>{item.abrasiveGrains}</StyledTd>
            <StyledTd>{item.size}</StyledTd>
            <StyledTd>{item.price}</StyledTd>
            <StyledTd><a href={item.url} target="_blank" rel="noreferrer">{item.url}</a></StyledTd>
            <StyledTd>
            <pre>
              <code>
